...
type ServerUptimeEvent struct {
	...
	// PMM Server STT Enabled state.
	SttEnabled bool `protobuf:"varint,5,opt,name=stt_enabled,json=sttEnabled,proto3" json:"stt_enabled,omitempty"`
	// PMM Server IA Enabled state.
	IaEnabled bool `protobuf:"varint,6,opt,name=ia_enabled,json=iaEnabled,proto3" json:"ia_enabled,omitempty"`
}
...
func (x *ServerUptimeEvent) GetSttEnabled() bool {
	if x != nil {
		return x.SttEnabled
	}
	return false
...
func (x *ServerUptimeEvent) GetIaEnabled() bool {
	if x != nil {
		return x.IaEnabled
	}
	return false
...
var file_telemetry_events_pmm_server_uptime_event_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xca, 0x02, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x55, 0x70, 0x74,
	...
	0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x74, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x73, 0x74, 0x74, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x61, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x61, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x2a,
